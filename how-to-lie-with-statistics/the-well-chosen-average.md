...
image: "/assets/img/statistics_skewed_income_centers.png"
date: 2026-08-12
...
درآمد چنین رفتاری ندارد. درآمد از پایین به صفر محدود است، اما در بالا می‌تواند ده‌ها یا صدها برابر شود. تعداد زیادی از مردم در بخش پایین و میانی توزیع قرار می‌گیرند و چند درآمد بسیار بزرگ، دنباله‌ای بلند در سمت راست می‌سازند. آماردان‌ها چنین توزیعی را **چوله** (*skewed*) می‌نامند؛ در توزیع متقارن این سه شاخص روی هم می‌افتند و در توزیع چوله، میانگین حسابی به سمت دنباله کشیده می‌شود.[<sup>۲</sup>](https://www.itl.nist.gov/div898/handbook/eda/section3/eda351.htm)
...
اگر پرسش این باشد که «نرخ تبدیل یک روز معمولی چقدر است؟»، متوسط روزها ممکن است معنایی داشته باشد؛ هرچند با دو روز داده پاسخ بسیار بی‌ثبات است. اگر می‌پرسیم «چه سهمی از کل بازدیدکنندگان خرید کردند؟»، باید شمار خریداران را بر شمار کل بازدیدکنندگان تقسیم کنیم.
