...
`$__range`{: dir="ltr"} همان بازه‌ای است که در تابلوی پایش انتخاب شده است. اکنون هر درخواست یک رأی دارد، نه هر پنجره. و اگر پرسش واقعاً سهمِ زمان باشد — «چند درصد از وقت‌ها سرویس در دسترس بود؟» — همان میانگینِ زمانی پاسخ درست است. مثل همیشه: اول پرسش، بعد پرس‌وجو.
