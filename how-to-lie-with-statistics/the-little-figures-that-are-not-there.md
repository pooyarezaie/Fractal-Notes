...
اگر در هر گروه فقط هزار نفر بوده باشند، یعنی در نسخه‌ی قبلی ۱۰۰ فروش و در نسخه‌ی تازه ۱۲۰ فروش دیده‌ایم. با یک محاسبه‌ی تقریبی، بازه‌ی سازگار با داده‌ها برای تفاوت دو نرخ از کمی پایین‌تر از صفر تا حدود ۴٫۷ واحد درصد کشیده می‌شود. داده‌ها هنوز با «اثر ناچیز یا حتی نبود اثر» هم سازگارند.
