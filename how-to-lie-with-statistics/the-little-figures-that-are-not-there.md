...
برای این برگه کافی است به یاد بسپاریم که عدد اصلی باید همراه اندازه‌ی اثر، داده‌های خام، بازه‌ی عدم‌قطعیت و روش آزمایش خوانده شود. در جدول‌های مقاله‌ها و گزارش‌ها رسم است نتیجه‌های «معنادار» را با ستاره‌ای کوچک و پانویسِ $p<0.05$ علامت بزنند؛ آن ستاره فقط می‌گوید نتیجه از یک آستانه‌ی قراردادی گذشته است و جای هیچ‌کدام از آن اطلاعات را نمی‌گیرد.
